	...
	<div class="entry-meta">
		...
		<span class="byline"><?php esc_html_e( 'by', 'graphy' ); ?>
			<span class="author vcard">
				<a class="url fn n" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php printf( esc_html__( 'View all posts by %s', 'graphy' ), get_the_author() );?>">
...
function graphy_author_profile() {
	...
	<div class="author-profile">
		...
		<div class="author-profile-description">
			...
			<a class="author-profile-description-link" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
				<?php printf( esc_html__( 'View all posts by %s &rarr;', 'graphy' ), get_the_author() ); ?>
			</a>
