...
function graphy_scripts() {
	...
	wp_enqueue_style( 'graphy-style', get_stylesheet_uri(), array(), '2.0.2' );
	...
	wp_enqueue_script( 'graphy-functions', get_template_directory_uri() . '/js/functions.js', array(), '20160622', true );
}
